/*
This recipeView.js module handles:
    - Recipe Detail Presentation Logic
*/
    ...
    <figure class="recipe__fig">
        ...
        <div class="recipe__details">
          ...
          <button class="btn--round btn--bookmark">
            <svg class="">
              <use href="../assets/img/icons.svg#icon-bookmark${
